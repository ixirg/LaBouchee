...
namespace LaBouchee.Models.Services
{
    public class ShoppingCartRepository : iShoppingCartRepository
    {
        ...
        public ShoppingCartRepository(LaBoucheeDbContext dbContext)
        {
        ...
        public static ShoppingCartRepository GetCart(IServiceProvider services)
        {
            ...
            LaBoucheeDbContext context = services.GetService<LaBoucheeDbContext>() ?? throw new Exception("Error initializing LaBoucheeDbContext");
